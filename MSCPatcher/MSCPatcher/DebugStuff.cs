	...
	class DebugStuff {
		...
		public static int checkDebugStatus() {
			if (Form1.mscPath != "(unknown)") {
				...
				case MD5FileHashes.mono32normal: return 1;
				case MD5FileHashes.mono32debug: return 2;
				case MD5FileHashes.mono64normal: return 3;
				case MD5FileHashes.mono64debug: return 4;
				default: return 0;
				}
			}
			return 0;
		...
		public static void DisableDebugging() {
			...
			MessageBox.Show("Debugging Disabled successfully!", "Success",
					MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
	}
}
