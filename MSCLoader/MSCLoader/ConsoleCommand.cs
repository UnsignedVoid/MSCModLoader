namespace MSCLoader {
	...
	public abstract class ConsoleCommand {
		...
		/// <summary>
		/// The name of the ConsoleCommand (What the user will have to type in console to
		/// trigger the command). Cannot contain spaces!
		/// </summary>
		public abstract string Name { get; }

		/// <summary>
		/// The help message that will be displayed for the command when the user types
		/// "help"
		/// </summary>
		...
		public static void Add(ConsoleCommand cmd) {
			if (string.IsNullOrEmpty(cmd.Alias))
				...
				cc.RegisterCommand(cmd.Name.ToLower(), cmd.Run, cmd.Help,
						cmd.Alias.ToLower(), cmd.ShowInHelp);
		}
	}
}
