...
namespace MSCLoader {
	...
	public class Keybind {
		...
		public static void Add(Mod mod, Keybind key) {
			...
			Keybinds.Add(key);
			DefaultKeybinds.Add(
					new Keybind(key.ID, key.Name, key.Key, key.Modifier) { Mod = mod });
		}
		/// <summary>
		...
		public static void AddHeader(Mod mod, string HeaderTitle) => AddHeader(
				mod, HeaderTitle, Color.blue, Color.white);
		...
		public static void AddHeader(
				Mod mod, string HeaderTitle, Color backgroundColor) => AddHeader(mod,
				HeaderTitle, backgroundColor, Color.white);
		...
		public static void AddHeader(
				Mod mod, string HeaderTitle, Color backgroundColor, Color textColor) {
		...
		public static List<Keybind> GetDefault(Mod mod) => DefaultKeybinds.FindAll(
				x => x.Mod == mod);
		...
		/// <param name="key">The KeyCode the user will press.</param>
		/// <param name="modifier">The modifier KeyCode the user will have to
		/// press.</param> <example><code source="Examples.cs" region="KeyBind2"
		/// lang="C#" title="Keybind and modifier" /></example>
		...
		public bool IsPressed() { return GetKeybind(); }
		...
		public bool IsDown() { return GetKeybindDown(); }
	}
}
