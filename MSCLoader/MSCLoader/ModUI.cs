...
#pragma warning disable CS1591
		...
		public static void CreateCanvas() {
			...
			canvasGO.GetComponent<CanvasScaler>().screenMatchMode =
...
#pragma warning restore CS1591
		...
		public static void ShowMessage(string message) => ShowMessage(
				message, "Message");
		...
		public static void ShowMessage(string message, string title) {
			...
			GameObject.Instantiate(messageBoxBtn)
					.transform.SetParent(mb.transform.GetChild(0).GetChild(2), false);
			mb.transform.GetChild(0).GetChild(0).GetChild(0).GetComponent<Text>().text =
					title.ToUpper();
			mb.transform.GetChild(0).GetChild(1).GetChild(0).GetComponent<Text>().text =
					message;
			mb.transform.GetChild(0)
					.GetChild(2)
					.GetChild(0)
					.GetComponent<Button>()
					.onClick.AddListener(() => GameObject.Destroy(mb));
			mb.transform.GetChild(0)
					.GetChild(2)
					.GetChild(0)
					.GetChild(0)
		...
		public static void ShowYesNoMessage(string message,
				Action ifYes) => ShowYesNoMessage(message, "Question", ifYes);
